...
export const Navbar = ({sidebarToggle, setSidebarToggle}) => {
  ...
  return (
    <>
      <nav className={`${sidebarToggle ? "" : " ml-72 "}  w-full  bg-zinc-200 px-4 py-3 flex justify-between`}>
      ...
      <div className="flex item-center gap-x-5">
        ...
        <div className="relative">
            ...
            <div className="z-10 hidden bg-white absolute  shadow w-32 group-focus:block top-full right-0">
                ...
                <Link to={'/profile'}><li className="p-2 rounded hover:shadow hover:bg-violet-700 hover:text-white">
                       Profile <i className="fa-regular fa-user ml-1"></i>
                    </li></Link> 
